...
export default function SmartMeterItem({ deployedSM }) {
  return (
    <div className="sm-container" style={{ flexWrap: "wrap" }}>
      <div
        style={{
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        <div className="consuption-production">
          <p>
            <span style={{ color: "green", fontWeight: "bolder" }}>
              +{deployedSM.consumption}
            </span>
            kwh
          </p>
          <p>
            <span style={{ color: "red", fontWeight: "bolder" }}>
              -{deployedSM.production}
            </span>
            kwh
          </p>
        </div>
      </div>
      <div className="smart-hub-id">
        <div className="smart-hub-id-name-status">
          <p className="smart-hub-name">SMARTHUB ID </p>
          <p className="smart-hub-status">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 29 29"
              width="29"
            ...
            >
              <path
                id="Shape 7"
                className="shp0"
                d="M14.52 7.81C18.31 7.81 21.39 10.88 21.39 14.68C21.39 18.47 18.31 21.54 14.52 21.54C10.73 21.54 7.66 18.47 7.66 14.68C7.66 10.88 10.73 7.81 14.52 7.81Z"
              />
            </svg>
          </p>
        </div>
        <div className="smart-hub-result">
          <p>{deployedSM._id}</p>
        </div>
      </div>
    </div>
